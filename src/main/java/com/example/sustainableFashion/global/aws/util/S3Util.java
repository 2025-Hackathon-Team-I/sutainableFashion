package com.example.sustainableFashion.global.aws.util;

import com.example.sustainableFashion.global.aws.exception.S3Exception;
import com.example.sustainableFashion.global.aws.exception.code.S3ErrorCode;
...
public class S3Util {
    ...
    // S3 URL 접두사 설정하셔야 합니다.
    private static final String PREFIX = "https://s3.ap-northeast-2.amazonaws.com/";
